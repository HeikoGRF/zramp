...
RESULTS_ROOT=${RESULTS_ROOT:-${REPO_ROOT}/artifacts/luxembourg_cell_grid_synchronized_9map_paper_final_v1}
DATA_ROOT=${DATA_ROOT:-/usr/itetnas04/data-scratch-01/hgraef/data/luxembourg_real_city}
BUNDLE=${BUNDLE:-${REPO_ROOT}/trained_models/paper_runtime/cell_grid_patch_acquisition_v1_c16_pq4x256/bundle.pt}
SUBMIT_SCRIPT=${SUBMIT_SCRIPT:-${REPO_ROOT}/experiments/place_wallis_benchmark/submit_support_expert_bank.sh}

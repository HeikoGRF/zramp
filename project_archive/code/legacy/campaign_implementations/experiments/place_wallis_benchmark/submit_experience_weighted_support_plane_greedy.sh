#!/usr/bin/env bash
#SBATCH --job-name=wallis-plane-exp
...
RESULTS_DIR=${RESULTS_DIR:-${REPO_ROOT}/artifacts/place_wallis_benchmark/methods/experience_weighted_support_plane_greedy_eval50_tail10x25}

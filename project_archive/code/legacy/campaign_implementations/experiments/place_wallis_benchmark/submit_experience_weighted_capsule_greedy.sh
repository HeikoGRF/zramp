#!/usr/bin/env bash
#SBATCH --job-name=wallis-exp-capsule
...
RESULTS_DIR=${RESULTS_DIR:-${REPO_ROOT}/artifacts/place_wallis_benchmark/methods/experience_weighted_capsule_greedy_eval50_tail10x25}
...
"${PYTHON_BIN}" experiments/place_wallis_benchmark/run_finite_capsule_greedy.py "${RUN_ARGS[@]}"

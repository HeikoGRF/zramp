#!/usr/bin/env bash
#SBATCH --job-name=wallis-rbf-greedy
...
RESULTS_DIR=${RESULTS_DIR:-${REPO_ROOT}/artifacts/place_wallis_benchmark/methods/bounded_rbf_greedy_eval50_tail10x25}
...
"${PYTHON_BIN}" experiments/place_wallis_benchmark/run_bounded_rbf_greedy.py "${RUN_ARGS[@]}"

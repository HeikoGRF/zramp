#!/usr/bin/env bash
#SBATCH --job-name=wallis-binary-exp
...
RESULTS_DIR=${RESULTS_DIR:-${REPO_ROOT}/artifacts/place_wallis_benchmark/methods/experience_weighted_binary_support_plane_greedy_eval50_tail10x25}

#!/usr/bin/env bash
#SBATCH --job-name=wallis-overlap-equal
...
RESULTS_DIR=${RESULTS_DIR:-${REPO_ROOT}/artifacts/place_wallis_benchmark/methods/overlapping_plane_greedy_eval50_tail10x25}

#!/usr/bin/env python3
"""Train on random and policy-induced artificial deployments only."""
...
def main() -> int:
    ...
    checkpoint = {
        ...
        "training_target": "oracle-geometry-alpha",
        "source_state_process": "random plus frozen-policy-induced exact artificial deployment evolution",
    ...
    report = {
        "format": "onpolicy_augmented_source_policy_report_v1",
        "protocol": {
            "fit_and_selection": "artificial maps only",
            "deployment_map_used": False,
            "random_training_included": not bool(args.no_random_training),
            "onpolicy_repeats": repeats,
            "training_target": "oracle gain at metadata-selected alpha",
        },
        "seed": int(args.seed),
